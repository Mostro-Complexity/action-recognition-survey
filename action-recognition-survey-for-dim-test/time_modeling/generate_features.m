function [data, labels] = generate_features(dataset, feature_type, n_desired_frames)
            ...
            for action = 1:n_actions
                for instance = 1:n_instances
                    if (skeletal_data_validity(action, subject, instance))                    
                        ...
                        joint_locations = skeletal_data{action, subject, instance}.joint_locations;   %#ok<*USENS>
    ...
    elseif (strcmp(dataset, 'Florence3D') || strcmp(dataset, 'G3D'))    
        ...
        labels.action_labels = action_labels;
        labels.subject_labels = subject_labels;
