function [] = general_classification_with_subsets(root_dir, ...
    subject_labels, action_labels, tr_subjects, te_subjects, action_sets, action_names)
    ...
    for set = 1:n_action_sets
        ...
        for i = 1:n_tr_te_splits         
            ...
            [total_accuracy(i), cw_accuracy(i,:), confusion_matrices{i}] =...
                hidden_markov_model(features_train,...
