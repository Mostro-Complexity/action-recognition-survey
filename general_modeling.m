function [] = general_modeling(dataset_idx, feature_idx,...
    ...
    general_classification(directory, labels.subject_labels, labels.action_labels,...
        tr_info.tr_subjects, tr_info.te_subjects, action_names.action_names);

    if (strcmp(datasets{dataset_idx}, 'MSRAction3D'))
        general_classification_with_subsets(directory, labels.subject_labels,...
