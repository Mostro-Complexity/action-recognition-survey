function [warped_curves] = warp_the_curves(nominal_curve, curves)
    % Reduce the noise by wraping the time series.
    % DTW algorithm implements warping time series.
    ...
    for i = 1:n_curves
        ...
        matches = dtw(dist);
        % This function above calculates the Euclidean distance 
        % in pairs using the row vectors of the matrix.
